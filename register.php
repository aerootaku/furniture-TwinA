...
if(isset($_POST['register'])){
    ...
    if(isExists('tbl_users', $where = array("username"=>$_POST['username'], "email"=>$_POST['email'])) == 1){
        ...
        $url = "<a href=\"http://twinafurniture.com/verify.php?rand=$rand\">VERIFY ACCOUNT</a>";
        $to = $_POST['email'];
        $subject = "Thank you!";
//            $message = "Thank you for registering at Cemetery Management System. Please visit this link to confirm your account:".$url;
        $message = "
                <html> 
                  <body>
                 <p>Thank you for registering at TwinA. Please click the link below to verify your account</p>
                 <a href='http://twinafurniture.com/verify.php?rand=$rand'>Verify</a>
                  </body> 
                </html>
                ";
