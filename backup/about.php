												...
												<li><a href="#">Features <i class="ion-ios-arrow-down"></i></a>
                                                    <ul class="mega-menu">
                                                        ...
                                                        <li class="mega-menu-img">
                                                            <ul>
                                                                <li><a class="dot-none" href="shop.html"><img alt="" src="shop/assets/img/banner/17.jpg"></a></li>
                                                            </ul>
                                                        </li>
                                                    </ul>
                                                </li>
                                                ...
                                                <ul class="ht-dropdown main-cart-box">
                                                    <li>
                                                        ...
                                                        <div class="single-cart-box">
                                                            <div class="cart-img">
                                                                <a href="#">
                                                                    <img alt="cart-image" src="shop/assets/img/products/mini1.jpg">
                                                                </a>
                                                            </div>
                                                        ...
                                                        <div class="single-cart-box">
                                                            <div class="cart-img">
                                                                <a href="#">
                                                                    <img alt="cart-image" src="shop/assets/img/products/mini2.jpg">
                                                                </a>
                                                            </div>
                                                            <div class="cart-content">
                                                                <h6>
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col-xl-6 col-lg-12 d-none d-xl-block">
                        <div class="banner_h2__left_image">
                            <img alt="" src="shop/assets/img/banner/about-us-img1.jpg">
                        </div>
                    </div>
            ...
            <div class="funfacts">
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <div class="funfact">
                            <div class="fun__fact_img">
                                <img src="shop/assets/img/icon-img/about-us-icon1.png" alt="">
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <div class="funfact">
                            <div class="fun__fact_img">
                                <img src="shop/assets/img/icon-img/about-us-icon2.png" alt="">
                            </div>
                            <div class="fun_fact_info">
                                <h1>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <div class="funfact">
                            <div class="fun__fact_img">
                                <img src="shop/assets/img/icon-img/about-us-icon3.png" alt="">
                            </div>
                            <div class="fun_fact_info">
                                <h1>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <div class="funfact">
                            <div class="fun__fact_img">
                                <img src="shop/assets/img/icon-img/about-us-icon4.png" alt="">
                            </div>
                            <div class="fun_fact_info">
                                <h1>
                                    <span class="counter">2169</span>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12">
                        <div class="banner_h2__left_image lft_to_right">
                            <img alt="" src="shop/assets/img/banner/about-us-img2.jpg">
                        </div>
                    </div>
                </div>
            </div>
