                                                ...
                                                <div class="product-wrapper mb-60">
                                                    <div class="product-img" align="center">
                                                        ...
                                                        <div class="product-action-2">
                                                            ...
                                                            <a href="shopping-action.php?addCart=1&name=<?= $r['name']; ?>&qty=1&img=<?= $r['prod_img']; ?>&price=<?= $r['price']; ?>" title="Add To Cart"  class="action-plus-2 tooltip">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="quick-view-learg-img">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        $value3 = custom_query("SELECT * FROM tbl_rating WHERE prod_id = '$prod_id' ORDER BY id DESC LIMIT 5");
                        ...
                        <div class="qwick-view-right">
                            <div class="qwick-view-content">
                                ...
                                $value1 = custom_query("SELECT sum(rating) as rate FROM tbl_rating WHERE prod_id = '$prod_id' ORDER BY id DESC");
                                if($value1->rowCount()>0)
                                {
                                while($r1=$value1->fetch(PDO::FETCH_ASSOC))
                                {
                                    $value2 = custom_query("SELECT COUNT(prod_id) as prod_count FROM tbl_rating WHERE prod_id = '$prod_id' ORDER BY id DESC");
