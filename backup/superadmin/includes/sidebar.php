                ...
                <ul id="main-menu" class="metismenu">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li><a href="user-manage-admin.php">Manage Admin</a></li>
                            <li><a href="user-manage-secretary.php">Manage Secretary</a></li>
                            <li><a href="user-manage-accountant.php">Manage Accountant</a></li>
                            <li><a href="user-manage-clients.php">Manage Client</a></li>
                        </ul>
                    </li>
                    <li>
...
<!--                    <li class="">-->
<!--                        <a href="backup-restore.php"><i class="fa fa-database"></i> <span>Backup & Restore</span></a>-->
<!--                    </li>-->
                    <li class="">
                        <a href="payment-options.php"><i class="glyphicon glyphicon-usd"></i> <span>Payment Options</span></a>
                    </li>
                    <li>
                        <a href="#configure" class="has-arrow"><i class="icon-settings"></i> <span>Configure</span></a>
                        <ul>
