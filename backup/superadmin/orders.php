                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if($r['status'] == 'Pending'): ?>
                                                        <button type="button" class="btn btn-success mr-3" title="Edit" data-target="#approve-record<?=$id; ?>" data-toggle="modal"><i class="fa fa-check"></i></button>
                                                    <?php endif; ?>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="?id=<?= $id; ?>" method="POST">
                        ...
                        <div class="modal-body"> This order will be marked as approve</div>
