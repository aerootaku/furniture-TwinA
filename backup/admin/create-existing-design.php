...
if(isset($_POST['register'])){
    ...
    $filetmp = $_FILES["front"]["tmp_name"];
    $filename = $_FILES["front"]["name"];
    $filepath = $_FILES["front"]["type"];
    $front  = "../uploads/".$filename;
    move_uploaded_file($filetmp,$front);


    $filetmp = $_FILES["back"]["tmp_name"];
    $filename = $_FILES["back"]["name"];
    $filepath = $_FILES["back"]["type"];
    $back  = "../uploads/".$filename;
    move_uploaded_file($filetmp,$back);

    $filetmp = $_FILES["left"]["tmp_name"];
    $filename = $_FILES["left"]["name"];
    $filepath = $_FILES["left"]["type"];
    $left  = "../uploads/".$filename;
    move_uploaded_file($filetmp,$left);

    $filetmp = $_FILES["right"]["tmp_name"];
    $filename = $_FILES["right"]["name"];
    $filepath = $_FILES["right"]["type"];
    $right  = "../uploads/".$filename;
    move_uploaded_file($filetmp,$right);

    $filetmp = $_FILES["top"]["tmp_name"];
    $filename = $_FILES["top"]["name"];
    $filepath = $_FILES["top"]["type"];
    $top  = "../uploads/".$filename;
    move_uploaded_file($filetmp,$top);

    $filetmp = $_FILES["inner"]["tmp_name"];
    $filename = $_FILES["inner"]["name"];
    $filepath = $_FILES["inner"]["type"];
    $inner  = "../uploads/".$filename;
    move_uploaded_file($filetmp,$inner);
                        ...
                        <div class="body">
                            <form id="basic-form" method="POST" enctype="multipart/form-data" novalidate>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="card">
                                        <div class="body">
                                            <input type="file" class="dropify" name="front">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="card">
                                        <div class="body">
                                            <input type="file" class="dropify" name="back">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="card">
                                        <div class="body">
                                            <input type="file" class="dropify" name="left">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="card">
                                        <div class="body">
                                            <input type="file" class="dropify" name="right">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="card">
                                        <div class="body">
                                            <input type="file" class="dropify" name="top">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="card">
                                        <div class="body">
                                            <input type="file" class="dropify" name="inner">
                                        </div>
                                    </div>
                                </div>
                                <hr />
