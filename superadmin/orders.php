...
if(isset($_POST['approve'])){
    ...
    $edit = db_update('tbl_orders', $data, $id = array("id"=>$_GET['id']));
    if(isset($edit)){
        db_insert('tbl_logs', $data = array("transaction"=>$_POST['or_no'].' Order has been Approved', "created_by"=>$_SESSION['username']));
        $to = $_POST['contact'];
...
if(isset($_POST['delivery'])){
    ...
    $edit = db_update('tbl_orders', $data, $id = array("id"=>$_GET['id']));
    if(isset($edit)){
        db_insert('tbl_logs', $data = array("transaction"=>$_POST['or_no'].' Order has been Mark for Delivery', "created_by"=>$_SESSION['username']));
        $to = $_POST['contact'];
                                    ...
                                    if($value->rowCount()>0)
                                    {
                                        while($r=$value->fetch(PDO::FETCH_ASSOC))
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $r['prod_color']; ?></td>
                                                <!--                                                <td>--><?//= $r['or_type']; ?><!--</td>-->
                                                <td><?php if($r['status'] =='Delivery'){echo "Delivering";} else { echo $r['status']; }; ?></td>                                                <td>
