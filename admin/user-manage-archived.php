...
if(isset($_POST['delete'])){
    ...
    if(isset($delete)){
        db_insert('tbl_logs', $data = array("transaction"=>$_POST['username'].' Information has been deleted', "created_by"=>$_SESSION['username']));
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover js-basic-example dataTable table-custom">
                                    ...
                                    <?php
                                    $xid = $_SESSION['id'];
                                    $value = custom_query("SELECT * FROM tbl_users WHERE status ='Archived' ORDER BY id DESC");
                                    if($value->rowCount()>0)
                                    {
