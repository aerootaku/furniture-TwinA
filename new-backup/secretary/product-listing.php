...
//    print_r($data);
    if(isExists('tbl_products', $where = array("name"=>$_POST['name'])) == 1){
        ...
        if(isset($insert)){
            db_insert('tbl_logs', $data = array("transaction"=>$_POST['name'].' Information has been created', "created_by"=>$_SESSION['username']));
...
if(isset($_POST['edit'])){
    ...
    if(isset($edit)){
        db_insert('tbl_logs', $data = array("transaction"=>$_POST['name'].' Information has been Edited', "created_by"=>$_SESSION['username']));
