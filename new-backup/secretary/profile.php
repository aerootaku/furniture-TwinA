                                    ...
                                    <div class="body">
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-lg-12 col-md-12">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" name="middlename" class="form-control" placeholder="Middle Name" value="<?= $r['middlename']; ?>" required>
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" name="lastname" class="form-control" placeholder="Last Name" value="<?= $r['lastname']; ?>" required>
                                                </div>
                                                <div class="form-group">
                                                    <input type="date" class="form-control" value="<?= $r['birthday']; ?>" required name="birthday" />
                                                </div>
                                                <div class="form-group">
                                                    <div>
