...
if(isset($_POST['create'])){
    $data = array(
        ...
        $insert = db_insert('tbl_payment_options', $data);
        if(isset($insert)){
            db_insert('tbl_logs', $data = array("transaction"=>$_POST['mode_of_payment'].' Information has been Created', "created_by"=>$_SESSION['username']));
...
if(isset($_POST['edit'])){
    ...
    $edit = db_update('tbl_payment_options', $data, $id = array("id"=>$_GET['id']));
    if(isset($edit)){
        db_insert('tbl_logs', $data = array("transaction"=>$_POST['mode_of_payment'].' Information has been Edited', "created_by"=>$_SESSION['username']));
...
if(isset($_POST['delete'])){
    $delete = db_delete('tbl_payment_options', $id = array("id"=>$_GET['id']));
    if(isset($delete)){
        $_SESSION['toastr'] = array(
            'type'=>'warning',
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-5 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Payment Options</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php"><i class="icon-home"></i></a></li>
                            <li class="breadcrumb-item active">Manage Payment Options</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content">
            <form action="" method="POST">
                <div class="modal-header">
                    <h4 class="title" id="defaultModalLabel">Create New Payment Method</h4>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label>Mode of Payment</label>
                        <input type="text" class="form-control" required name="mode_of_payment">
                    </div>
                    <div class="form-group">
                        <textarea class="summernote" placeholder="Enter some description of your payment" name="description">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <form action="?id=<?= $id; ?>" method="POST">
                        ...
                        <div class="modal-body"> Are you sure you want to remove this mode of payment?</div>
                        <div class="modal-footer">
                ...
                <div class="modal-content">
                    <form action="?id=<?= $id; ?>" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label>Mode of Payment</label>
                                <input type="text" class="form-control" required name="mode_of_payment" value="<?= $r['mode_of_payment']; ?>">
                            </div>
                            <div class="form-group">
                                <textarea class="summernote" placeholder="Enter some description of your payment" name="description">
                                    <?= $r['description']; ?>
