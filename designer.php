...
<!--                                </div>-->
                                ...
                                <br /><br />
                                <div class="form-group">
                                    <label>Leg Design</label>
                                    <br />
                                    <select name="feet" class="form-control" id="feet">
                                        <option value="feet1">Leg Design A</option>
                                        <option value="feet2">Leg Design B</option>
                                        <option value="feet3">Leg Design C</option>
                                        <option value="feet4">Leg Design D</option>
                                    </select>
                                </div>
                                <br /><br />
                                <div class="form-group">
...
<script>
    $(document).ready(function() {
        ...
        $("#generate").on("click", function (e) {
            ...
            else if(back == 'back1' && feet == 'feet4'){
                $("#Customimg").html("<img src='Chairs/Chi1.png' style='max-width: 1000px'/>");
            }
            ...
            else if(back == 'back2' && feet == 'feet4'){
                $("#Customimg").html("<img src='Chairs/Chi2.png' style='max-width: 1000px'/>");
            }
            ...
            else if(back == 'back3' && feet == 'feet4'){
                $("#Customimg").html("<img src='Chairs/Chi3.png' style='max-width: 1000px'/>");
            }
            ...
            else if(back == 'back4' && feet == 'feet4'){
                $("#Customimg").html("<img src='Chairs/ChiDefault.png' style='max-width: 1000px'/>");
            }
